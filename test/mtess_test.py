...
#        '''
        mts, mtsp, nmts, nmtsp, means, stds, acs, pacs, cms, pcms, ccms, pccms, mkts = \
            measures.mtess.calc(cx=cx, mtrange=[0, 1], ac_lags=5, pac_lags=13, cc_lags=2, pcc_lags=4)
...
#        dnames = ['original', '2']
        ...
        ret = measures.mtess.calc(cx=cx2, mtrange=[0, 1], ac_lags=5, pac_lags=13, cc_lags=2, pcc_lags=4)
