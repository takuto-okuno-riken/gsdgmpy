...
class ParseMtessOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--cclag', nargs=1, default=8, help='time lag <num> for Cross Correlation (default:8)')
        self.parser.add_argument('--pcclag', nargs=1, default=8, help='time lag <num> for Partial Cross Correlation (default:8)')
        self.parser.add_argument('--outpath', nargs=1, default='results', help='output files path (default:"results")')
        self.parser.add_argument('--format', type=int, default=0, help='save file format <type> 0:csv, 1:mat (default:0)')
