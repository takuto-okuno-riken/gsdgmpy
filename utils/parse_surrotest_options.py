...
class ParseOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--g',  action='store_true', help='output Gaussian distribution test (<original>_gauss_test.csv)')
        self.parser.add_argument('--l',  action='store_true', help='output Linearity test  (<original>_linear_test.csv)')
        self.parser.add_argument('--i',  action='store_true', help='output I.I.D test (<original>_iid_test.csv)')
